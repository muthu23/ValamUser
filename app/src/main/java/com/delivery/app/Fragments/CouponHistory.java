...
import com.delivery.app.Activities.WelcomeScreenActivity;
...
import com.delivery.app.Models.CouponHistoryData;
    ...
    private class PostAdapter extends RecyclerView.Adapter<PostAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(PostAdapter.MyViewHolder holder, int position) {
            try {
                ...
                holder.date.setText("" + getDate(lstCouponHistory.get(position).createdAt) + " " + Utilities
                        .getMonth(lstCouponHistory.get(position).createdAt) + " " + getYear(lstCouponHistory.get(position).createdAt));
