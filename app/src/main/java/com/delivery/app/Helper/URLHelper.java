...
public class URLHelper {
    ...
    public static final String client_secret = "IM8h2JNdnUu3do1yC8MHQOzJ1I2LFnZMgPBhYVr4";
    public static final String STRIPE_TOKEN = "pk_test_51H5jyQLCxfvliLTrxhSRK7Zb1mJkjsnADzlzmFcFVAvEXj2UPOJHihZomCmPH1oHP16bU6iIk3JU4zUBH5qLHw8g005WZa7w5F";
    public static final String login = base + "oauth/token";
    public static final String register = base + "api/user/signup";
    public static final String otp = base + "api/user/otp";
    public static final String voiceOtp = base + "api/user/voice/sms";
